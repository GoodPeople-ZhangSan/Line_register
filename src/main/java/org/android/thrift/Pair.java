...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.19.0)", date = "2024-12-24")
public class Pair implements org.apache.thrift.TBase<Pair, Pair._Fields>, java.io.Serializable, Cloneable, Comparable<Pair> {
  ...
  private static final org.apache.thrift.protocol.TField DEVICES_FIELD_DESC = new org.apache.thrift.protocol.TField("devices", org.apache.thrift.protocol.TType.STRING, (short)3);
  private static final org.apache.thrift.protocol.TField OS_FIELD_DESC = new org.apache.thrift.protocol.TField("os", org.apache.thrift.protocol.TType.STRING, (short)4);
  ...
  public @org.apache.thrift.annotation.Nullable String devices; // required
  public @org.apache.thrift.annotation.Nullable String os; // required
  ...
  public Pair setKey(@org.apache.thrift.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public Pair setValue(@org.apache.thrift.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public Pair setDevices(@org.apache.thrift.annotation.Nullable String devices) {
    this.devices = devices;
    return this;
  }
  ...
  public Pair setOs(@org.apache.thrift.annotation.Nullable String os) {
    this.os = os;
    return this;
  }
  ...
  public int compareTo(Pair other) {
    ...
    lastComparison = Boolean.compare(isSetDevices(), other.isSetDevices());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDevices()) {
    ...
    lastComparison = Boolean.compare(isSetOs(), other.isSetOs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOs()) {
  ...
  private static class PairStandardScheme extends org.apache.thrift.scheme.StandardScheme<Pair> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Pair struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // DEVICES
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.devices = iprot.readString();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Pair struct) throws org.apache.thrift.TException {
      ...
      if (struct.devices != null) {
        ...
        oprot.writeString(struct.devices);
        oprot.writeFieldEnd();
      }
      if (struct.os != null) {
